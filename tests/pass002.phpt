--TEST--
JSON (https://www.json.org/JSON_checker/test/pass2.json)
--FILE--
<?php
...
$obj = json5_decode($test);
var_dump($obj);
echo "DECODE: AS ARRAY\n";
$arr = json5_decode($test, true);
var_dump($arr);
...
$obj = json5_decode($obj_enc);
var_dump($obj);
echo "DECODE AGAIN: AS ARRAY\n";
$arr = json5_decode($arr_enc, true);
var_dump($arr);
